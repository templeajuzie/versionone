...
const content = {
  title: "Partnership / Joint Venture Visa (Worldwide)",
  description:
    "A business-focused immigration pathway that allows individuals to obtain residency by entering into a business partnership or joint venture with local or international companies abroad.",
  types: [
    "Partnership Visa",
    "Joint Venture Residency",
    "Business Partner Visa",
    "Co-Founder / Partner Visa",
    "Investment Partnership Permit",
  ],
  howToApply: [
    "Identify or form a business partnership/joint venture",
    "Meet investment or ownership requirements",
    "Prepare documents (passport, partnership agreement, business plan, proof of funds)",
    "Secure partnership approval or registration",
  ...
  benefits: [
    "Share business risks and resources",
    "Access to local market knowledge and networks",
    "Live and work abroad through business collaboration",
    "Family inclusion (spouse & children)",
    "Pathway to permanent residency and citizenship",
    "Growth potential through partnership",
  ],
  countries: [
    "United States",
    "Canada",
  ...
  who: [
    "Individuals seeking business collaborations",
    "Co-founders and business partners",
    "Investors preferring joint ventures",
    "Applicants targeting residency via shared business ownership",
  ],
};
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-partnership" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-partnership)" />
  </svg>
);

export default function PartnershipJointVentureVisaPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Partnership Visa</span>
            </nav>
            <motion.h1
            ...
            <div className="flex-1 space-y-20">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {content.types.map((type, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
                      <Users2 size={18} className="text-[#2D3E75]" />
              ...
              <div className="border-t border-zinc-100 pt-10">
                <p className="text-2xl font-black text-zinc-900 italic">
                  Partner with the best—secure your future through global business collaboration.
                </p>
              </div>
            </div>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Strategic Partnership</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your partnership visa application and secure your business future abroad.
                  </p>
                  <Link
                    href="/contact"
