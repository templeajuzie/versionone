...
const content = {
  title: "Golden Visa (Investment Residency) – Worldwide",
  description:
    "A premium pathway that allows individuals to obtain residency through investment, offering long-term stay, global mobility, and potential pathways to permanent residency or citizenship.",
  types: [
    "Golden Visa",
    "Residency by Investment",
    "Real Estate Investment Visa",
    "Capital / Fund Investment Visa",
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-golden" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-golden)" />
  </svg>
);

export default function GoldenVisaInvestmentResidencyPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Golden Visa</span>
            </nav>
            <motion.h1
            ...
            <div className="flex-1 space-y-20">
              ...
              <div className="border-t border-zinc-100 pt-10">
                <p className="text-2xl font-black text-zinc-900 italic">
                  Invest once—unlock residency, mobility, and a world of opportunities.
                </p>
              </div>
            </div>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Premium Investment</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert assessment for your Golden Visa application and secure your global lifestyle.
                  </p>
                  <Link
                    href="/contact"
