...
const content = {
  title: "Permanent Residency by Investment (Worldwide)",
  description:
  ...
  timeline: "3 – 12 months (average worldwide)",
  benefits: [
  ...
  countries: ["Canada", "Australia", "Portugal", "United States", "United Arab Emirates", "Malta"],
  who: [
    "High-net-worth individuals",
    "Investors seeking long-term settlement",
    "Business owners and entrepreneurs",
    "Families looking for secure global residency",
  ],
};
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-pr-inv" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-pr-inv)" />
  </svg>
);

export default function PRByInvestmentPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">PR by Investment</span>
            </nav>
            <motion.h1
            ...
            <div className="flex-1 space-y-20">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {content.types.map((type, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
                      <Gem size={18} className="text-[#2D3E75]" />
              ...
              <div className="border-t border-zinc-100 pt-10">
                <p className="text-2xl font-black text-zinc-900 italic">
                  Invest in your future—secure permanent residency and global opportunities.
                </p>
              </div>
            </div>
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Secure your global future through strategic residency by investment.
                  </p>
                  <Link
                    href="/contact"
