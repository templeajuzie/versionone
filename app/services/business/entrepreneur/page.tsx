...
const content = {
  title: "Entrepreneur Visa (Worldwide)",
  description:
  ...
  countries: ["Canada", "United Kingdom", "Australia", "New Zealand", "Netherlands", "France", "Portugal", "Ireland"],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-entrepreneur" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-entrepreneur)" />
  </svg>
);
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Entrepreneur Visa</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Launch Your Vision</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your entrepreneur visa application and expand your business globally.
                  </p>
                  <Link
                    href="/contact"
