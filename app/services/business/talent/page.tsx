...
const content = {
  title: "Business Talent Visa (Worldwide)",
  description:
  ...
  timeline: "4 – 12 weeks (average worldwide)",
  benefits: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-business-talent" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-business-talent)" />
  </svg>
);

export default function BusinessTalentVisaPage() {
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Business Talent</span>
            </nav>
            <motion.h1
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                  {content.countries.map((country, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-white p-4">
                      ...
                      <span className="text-sm font-bold text-zinc-700">{country.name}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Elite Business Talent</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    No job offer required for top business leaders. Secure your global residency today.
                  </p>
                  <Link
                    href="/contact"
