...
const content = {
  ...
  process: [
    ...
    "Arrive at immigration checkpoint",
    "Complete visa form (if required)",
    "Submit documents",
    "Pay visa fee",
    "Receive visa and enter country",
  ],
  howToApply: [
  ...
  timeline: "Immediate (Issued at arrival point)",
  benefits: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-voa" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-voa)" />
  </svg>
);
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-16 lg:flex-row">
            ...
            <div className="flex-1 space-y-20">
              ...
              {/* Application Process */}
              <div>
                <h2 className="mb-8 flex items-center gap-3 text-2xl font-black text-zinc-900">How It Works</h2>
              ...
              <div className="rounded-lg bg-[#2D3E75] p-10 text-white">
                <h2 className="mb-8 text-2xl font-black">What You Need</h2>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Ready to Arrive?</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Check your eligibility for VoA before you book your next international trip.
                  </p>
                  <Link
                    href="/contact"
