...
const categoryMeta = {
  description:
    "Hassle-free tourist, transit, medical, and business visas for short-term international travel and family visits across the globe.",
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                    {group.items.map((item, iIdx) => (
                      ...
                      >
                        <Link
                          href={item.link}
                          className="group flex items-center justify-between rounded-2xl border border-zinc-100 bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-emerald-100 hover:shadow-lg hover:shadow-emerald-500/5"
                        >
                          <span className="group-hover:text-primary text-sm font-bold text-zinc-700 transition-colors">
                            {item.name}
                          </span>
                          <div className="rounded-lg bg-zinc-50 p-2 text-zinc-300 transition-all group-hover:bg-emerald-50 group-hover:text-emerald-600">
