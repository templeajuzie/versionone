...
const content = {
  ...
  types: ["Tourist E-Visa", "Business E-Visa", "Transit E-Visa", "Short-Stay E-Visa", "Multiple-Entry E-Visa"],
  process: [
  ...
  timeline: "24 hours – 5 days (average worldwide)",
  benefits: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-evisa" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-evisa)" />
  </svg>
);
            ...
            <div className="flex-1 space-y-20">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {content.types.map((type, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
                      <Monitor size={18} className="text-[#2D3E75]" />
              ...
              <div className="border-t border-zinc-100 pt-10">
                <p className="text-2xl font-black text-zinc-900 italic">
                  Apply online, get approved fast, and travel with ease—no stress, no delays.
                </p>
              </div>
            </div>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Instant Approval</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your E-Visa application and travel with ease and speed.
                  </p>
                  <Link
                    href="/contact"
                  ...
                  >
                    Start Online <ArrowRight size={18} />
                  </Link>
                </div>
              </div>
            </aside>
