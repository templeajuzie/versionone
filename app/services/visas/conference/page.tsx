...
const content = {
  title: "Conference / Event Visit Visa (Worldwide)",
  description:
    "A specialized short-term visa that allows professionals, academics, and individuals to travel abroad to attend or speak at conferences, seminars, workshops, or business events.",
  types: [
    "Conference Visit Visa",
    "Seminar / Workshop Visa",
    "Academic Event Visa",
    "Exhibition / Trade Fair Visa",
    "Professional Event Participation Visa",
  ],
  process: [
    "Select destination country and event",
    "Confirm visa requirements for attendees",
  ...
  howToApply: [
    "Obtain invitation or registration confirmation from event organizer",
    "Prepare documents (passport, invitation letter, event agenda, proof of funds, accommodation)",
  ...
  benefits: [
    ...
    "Present research or business ideas abroad",
    "Short and streamlined application process",
    "Enhance professional and academic growth",
  ],
  who: [
    "Professionals and business delegates",
    "Academics and researchers",
    "Students attending workshops or seminars",
    "Individuals attending exhibitions or trade fairs",
  ],
};
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-conference" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-conference)" />
  </svg>
);

export default function ConferenceEventVisitVisaPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Conference & Events</span>
            </nav>
            <motion.h1
            ...
            <div className="flex-1 space-y-20">
              ...
              <div className="border-t border-zinc-100 pt-10">
                <p className="text-2xl font-black text-zinc-900 italic">
                  Expand your horizons—attend global events and connect with the world's best minds.
                </p>
              </div>
            </div>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Global Networking</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your conference visit visa application and attend international events with ease.
                  </p>
                  <Link
                    href="/contact"
