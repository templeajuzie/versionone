...
const content = {
  title: "Youth Mobility / Working Holiday Permit",
  description:
  ...
  process: [
    "Check eligibility (age & nationality)",
    "Apply under youth mobility program",
  ...
  benefits: [
    ...
    "Opportunity to extend or transition status",
  ],
  countries: [
    {
      name: "Canada",
    ...
    {
      name: "United Kingdom",
      points: ["Youth Mobility Scheme Visa", "Allows work and travel up to 2 years", "No employer restriction"],
    },
    {
      name: "Australia",
      points: ["Working Holiday Visa (subclass 417 & 462)", "Work and travel freely", "Option to extend stay"],
    },
    {
      name: "New Zealand",
      points: ["Working Holiday Visa", "Flexible work and travel", "Popular for tourism and seasonal jobs"],
    },
    {
      name: "Ireland",
      points: [
  ...
  who: [
    ...
    "Individuals looking for flexible short-term work",
    "People interested in cultural exchange",
  ],
};
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-youth" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-youth)" />
  </svg>
);

export default function YouthMobilityPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-16 lg:flex-row">
            ...
            <div className="flex-1 space-y-20">
              {/* Types */}
              <div>
                <h2 className="mb-8 flex items-center gap-3 text-2xl font-black text-zinc-900">Types of Permits</h2>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Start Your Adventure</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert assessment for your youth mobility or working holiday visa.
                  </p>
                  <Link
                    href="/contact"
