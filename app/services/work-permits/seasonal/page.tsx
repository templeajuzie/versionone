...
const content = {
  ...
  benefits: [
    ...
    "Possibility to reapply or transition",
  ],
  countries: [
    {
      name: "Canada",
    ...
    {
      name: "United Kingdom",
      points: ["Seasonal Worker Visa", "Agriculture and food processing jobs", "Short-term stay (up to 6 months)"],
    },
    {
      name: "Australia",
      points: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-seasonal" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-seasonal)" />
  </svg>
);

export default function SeasonalWorkPermitPage() {
  return (
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Seasonal Roles</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your seasonal work permit application and employer sponsorship.
                  </p>
                  <Link
                    href="/contact"
