...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-work-to-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-work-to-pr)" />
  </svg>
);

export default function WorkToPRPathwayPage() {
  return (
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert roadmap from your current work visa to permanent residency.
                  </p>
                  <Link
                    href="/contact"
