...
const content = {
  ...
  countries: [
    {
      name: "Canada",
      points: ["Job offer boosts Express Entry score", "Required for many LMIA-based permits", "Strong PR pathways"],
    },
    {
      name: "United Kingdom",
      points: ["Mandatory for Skilled Worker Visa", "Requires licensed sponsor", "Leads to settlement"],
    },
    {
      name: "Australia",
      points: ["Employer nomination pathways (482, 186)", "Supports PR applications", "High demand occupations"],
    },
    {
      name: "Germany",
      points: [
    ...
    },
    {
      ...
      points: ["Employer-sponsored system", "Fast processing", "Wide range of job opportunities"],
    },
  ],
  who: [
