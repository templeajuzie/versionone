...
import { ArrowRight, CheckCircle2, ChevronRight, Clock, FileText, Hammer, ShieldCheck } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

const content = {
  title: "Construction / Trade Worker Permit",
  description:
  ...
  countries: [
    ...
    {
      name: "United Kingdom",
      points: ["Skilled Worker Visa for trade roles", "Shortage occupation benefits", "Requires job offer"],
    },
    {
      name: "Germany",
      points: [
    ...
    },
    {
      ...
      points: ["Large construction projects", "Employer-sponsored permits", "Fast processing and relocation"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-construction" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-construction)" />
  </svg>
);

export default function ConstructionTradeWorkerPermitPage() {
  return (
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-zinc-900 p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Build Your Future</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Expert assistance for construction and trade worker permits worldwide.
                  </p>
                  <Link
                    href="/contact"
