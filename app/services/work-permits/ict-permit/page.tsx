...
const content = {
  ...
  countries: [
    {
      name: "Canada",
      points: ["LMIA-exempt ICT permit", "Fast processing", "PR pathway through Canadian work experience"],
    },
    {
      name: "United Kingdom",
      points: ["Senior or Specialist Worker Visa", "Requires UK branch sponsorship", "Limited settlement pathway"],
    },
    {
      name: "Australia",
      points: ["Subclass 482 (ICT stream)", "Employer sponsorship required", "Pathway to PR"],
    },
    {
      name: "Germany",
      points: ["EU ICT Card", "For managers, specialists, trainees", "Mobility across EU"],
    },
    {
      name: "Netherlands",
      points: ["ICT Permit / Highly Skilled Migrant route", "Recognized sponsor required", "Strong work-life balance"],
    },
  ],
  who: [
...
export default function IntraCompanyTransferPermitPage() {
  return (
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {content.types.map((type, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
                      <Briefcase size={18} className="text-[#2D3E75]" />
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Relocate with Ease</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert assessment for your intra-company transfer and move your expertise globally.
                  </p>
                  <Link
                    href="/contact"
