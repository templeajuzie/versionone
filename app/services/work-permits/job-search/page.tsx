...
const content = {
  ...
  countries: ["Germany", "Austria", "Portugal", "Spain", "Netherlands", "Sweden", "Finland", "France", "Denmark"],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-job-search" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-job-search)" />
  </svg>
);
            ...
            <div className="flex-1 space-y-20">
              ...
              <div>
                <h2 className="mb-8 flex items-center gap-3 text-2xl font-black text-zinc-900">
                  Countries Offering This Permit
                </h2>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Start Your Search</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your work search residence permit application and relocation planning.
                  </p>
                  <Link
                    href="/contact"
