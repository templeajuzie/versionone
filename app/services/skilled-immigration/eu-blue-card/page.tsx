...
const content = {
  ...
  countries: [
    ...
    {
      name: "Netherlands",
      points: ["Recognized sponsor required", "Competitive salary threshold", "Access to strong job market"],
    },
    {
      name: "Sweden",
      points: [
    ...
    {
      name: "Poland",
      points: ["Growing demand for foreign professionals", "Lower cost of living", "Expanding job opportunities"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-bluecard" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-bluecard)" />
  </svg>
);
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Relocate to Europe</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Discover your eligibility for the EU Blue Card scheme today.
                  </p>
                  <Link
                    href="/contact"
