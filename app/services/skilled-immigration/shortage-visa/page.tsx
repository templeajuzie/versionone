...
export default function SkilledOccupationShortageVisaPage() {
  return (
    <main className="min-h-screen pt-32">
        ...
        <h1 className="text-4xl font-bold text-[#2D3E75] mb-8 uppercase">Skilled Occupation Shortage Visa</h1>
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 min-h-[400px] flex items-center justify-center text-gray-400">
          Content for Skilled Occupation Shortage Visa is coming soon...
        </div>
      </div>
          </main>
  );
