...
import { ArrowRight, CheckCircle2, ChevronRight, Clock, FileText, Globe2, Hammer, ShieldCheck } from "lucide-react";
import Link from "next/link";

const content = {
  title: "Skilled Trade Worker Programs",
  description:
  ...
  process: [
    "Confirm trade is in demand",
    "Skills assessment / certification (if required)",
    "Secure job offer or enter points-based system",
  ...
  countries: [
    ...
    {
      name: "Australia",
      points: ["Skilled Occupation Lists include many trades", "Requires skills assessment", "PR pathways available"],
    },
    {
      name: "United Kingdom",
      points: ["Skilled Worker Visa for trade roles", "Requires job offer", "Shortage occupation benefits apply"],
    },
    {
      name: "Germany",
      points: [
    ...
    {
      name: "New Zealand",
      points: ["Trade roles on skill shortage lists", "Work-to-residence pathways", "High quality of life"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-trade" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-trade)" />
  </svg>
);

export default function SkilledTradeWorkerPage() {
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Trade Workers</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Relocate with Your Trade</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert evaluation of your trade certifications for global relocation.
                  </p>
                  <Link
                    href="/contact"
