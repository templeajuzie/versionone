...
const content = {
  title: "Permanent Residency for Skilled Workers",
  description:
  ...
  process: [
    "Eligibility assessment (skills, experience, education)",
    "Profile creation / application submission",
    "Points ranking or employer sponsorship",
  ...
  countries: [
    {
      name: "Canada",
      points: ["Express Entry and PNP pathways", "Direct PR for skilled workers", "Family-friendly immigration system"],
    },
    {
      name: "Australia",
      points: ["Skilled visas (189, 190) grant PR", "Strong demand for skilled professionals", "High quality of life"],
    },
    {
      name: "United Kingdom",
      points: ["Work visa leads to ILR after 5 years", "Points-based skilled system", "Strong job market"],
    },
    {
      name: "New Zealand",
      points: ["Skilled Migrant Category Resident Visa", "PR pathway after residency", "Balanced lifestyle"],
    },
    {
      name: "Germany",
      points: ["EU Blue Card to PR pathway", "Fast-track options for skilled workers", "Access to EU job market"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-pr)" />
  </svg>
);

export default function PermanentResidencySkilledWorkerPage() {
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Permanent Residency</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Settle Permanently</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert roadmap to permanent residency in your dream destination.
                  </p>
                  <Link
                    href="/contact"
                  ...
                  >
                    Start Your PR App <ArrowRight size={18} />
                  </Link>
                </div>
              </div>
            </aside>
