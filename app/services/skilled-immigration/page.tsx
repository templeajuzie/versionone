  ...
  return (
    <main className="min-h-screen pt-32">
      <div className="mx-auto max-w-7xl px-4 py-20">
        <h1 className="mb-8 text-4xl font-bold text-[#2D3E75] uppercase">SKILLED IMMIGRATION</h1>
        <div className="min-h-[400px] rounded-lg border border-gray-100 bg-white p-8 shadow-xl">
          <p className="text-lg text-gray-600">Explore our comprehensive SKILLED IMMIGRATION services and programs.</p>
