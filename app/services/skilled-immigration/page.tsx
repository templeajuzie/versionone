...
const activeCat = immigrationMegaMenu.find(c => c.title === "Skilled Immigration")!;
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {group.items.map((item, iIdx) => (
                      ...
                      >
                        <Link
                          href={item.link}
                          className="group flex items-center justify-between p-5 rounded-2xl border border-zinc-100 bg-white transition-all hover:border-blue-100 hover:shadow-lg hover:shadow-blue-500/5 hover:-translate-y-0.5"
                        >
                          <span className="text-sm font-bold text-zinc-700 group-hover:text-zinc-900 transition-colors">
                            {item.name}
                          </span>
                          <div className="p-2 rounded-lg bg-zinc-50 text-zinc-300 group-hover:bg-blue-50 group-hover:text-blue-600 transition-all">
