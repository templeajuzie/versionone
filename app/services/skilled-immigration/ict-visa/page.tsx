        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">ICT Visa</span>
            </nav>
            <motion.h1
            ...
            <p className="max-w-3xl text-lg leading-relaxed text-zinc-500">{ictContent.description}</p>
          </div>
        </div>
      </section>
            ...
            <div className="flex-1 space-y-20">
              ...
              <div>
                ...
                <div className="mt-8 rounded-3xl border border-zinc-100 bg-white p-8 shadow-sm">
                  <h3 className="mb-4 text-xl font-black text-zinc-900">{ictContent.netherlands.name}</h3>
                  <ul className="space-y-3">
                ...
                <div className="rounded-lg border border-zinc-100 bg-white p-8 shadow-sm">
                  <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-black text-zinc-900">{ictContent.timeline}</p>
                    </div>
                  </div>
