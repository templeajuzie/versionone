...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-short-skilled" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-short-skilled)" />
  </svg>
);
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Short-Term Success</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your short-term work permit application for projects or contract roles.
                  </p>
                  <Link
                    href="/contact"
