...
import { ArrowRight, CheckCircle2, ChevronRight, Clock, FileText, Search, ShieldCheck } from "lucide-react";
import Link from "next/link";

const content = {
  title: "Job Seeker Visa (Worldwide)",
  description:
  ...
  countries: [
    ...
    "Finland", "Norway", "Czech Republic", "France", "Ireland", "Denmark", "United Arab Emirates"
  ],
  who: [
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900 text-xs">Job Seeker Visa</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-zinc-900 p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Global Career</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Expert assistance for job seeker visas across 20+ countries.
                  </p>
                  <Link
                    href="/contact"
