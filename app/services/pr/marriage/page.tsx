...
const content = {
  title: "Marriage / Spousal Permanent Residency",
  description:
  ...
  process: [
    "Confirm eligibility of sponsor and applicant",
    "Submit sponsorship and PR application",
    "Provide proof of genuine relationship",
  ...
  countries: [
    {
      name: "Canada",
      points: ["Spousal sponsorship program", "Inland and outland application options", "Direct PR"],
    },
    {
      name: "Australia",
      points: ["Partner visa (temporary → permanent)", "Includes married and de facto partners", "Strong PR pathway"],
    },
    {
      name: "United Kingdom",
      points: ["Spouse visa leading to ILR", "Income and accommodation requirements", "PR after qualifying period"],
    },
    {
      name: "New Zealand",
      points: ["Partner residence visa", "Relationship-based eligibility", "Pathway to PR"],
    },
    {
      name: "United States",
      points: ["Marriage-based Green Card", "Immediate relative category for spouses", "Direct PR"],
    },
  ],
  who: [
    "Married couples",
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-marriage" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-marriage)" />
  </svg>
);

export default function MarriageSpousalPRPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Marriage & Spousal</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">United Futures</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get expert legal guidance on spousal sponsorship and partnership residency applications.
                  </p>
                  <Link
                    href="/contact"
