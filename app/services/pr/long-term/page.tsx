...
const content = {
  title: "Long-Term Residency Permits",
  description:
  ...
  timeline: "1 – 6 months (after eligibility is met)",
  benefits: [
  ...
  countries: [
    ...
    {
      name: "France",
      points: ["Long-Term Residence Card (10 years)", "Renewable and stable residency", "Pathway to citizenship"],
    },
    {
      name: "Netherlands",
      points: ["Long-term residence after 5 years", "Integration requirements apply", "Access to EU mobility"],
    },
    {
      name: "Portugal",
      points: ["Residency leading to long-term permit", "Flexible stay options", "Citizenship pathway"],
    },
    {
      name: "Spain",
      points: ["Long-term residence after 5 years", "Renewable permits", "Access to EU travel"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-long-term" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-long-term)" />
  </svg>
);

export default function LongTermResidencyPermitsPage() {
  return (
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Extended Settlement</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help transitioning to a long-term residency permit and secure your life abroad.
                  </p>
                  <Link
                    href="/contact"
