...
const content = {
  ...
  process: [
    "Choose country and investment option",
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-golden-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-golden-pr)" />
  </svg>
);

export default function GoldenVisaResidencybyInvestmentPage() {
  return (
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert assessment for your Golden Visa residency application and secure your global future.
                  </p>
                  <Link
                    href="/contact"
