...
const content = {
  title: "Skilled Worker Permanent Residency",
  description:
  ...
  process: [
    "Eligibility assessment (skills, education, experience)",
    "Profile creation / application submission",
    "Points ranking or selection",
  ...
  countries: [
    {
      name: "Canada",
      points: ["Express Entry and PNP pathways", "Points-based selection system", "Direct PR for skilled workers"],
    },
    {
      name: "Australia",
      points: ["Skilled visas (189, 190) grant PR", "Points-based system", "High demand for skilled professionals"],
    },
    {
      name: "United Kingdom",
      points: ["Skilled Worker Visa leads to ILR", "Typically after 5 years", "Points-based system"],
    },
    {
      name: "New Zealand",
      points: ["Skilled Migrant Category Resident Visa", "Points-based selection", "PR pathway after residency"],
    },
    {
      name: "Germany",
      points: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-skilled-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-skilled-pr)" />
  </svg>
);

export default function SkilledWorkerPRPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Skilled Worker PR</span>
            </nav>
            <motion.h1
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {content.types.map((type, i) => (
                    <div key={i} className="flex items-center gap-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
                      <Award size={18} className="text-[#2D3E75]" />
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Direct Settlement</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert points calculation and eligibility check for skilled worker PR programs.
                  </p>
                  <Link
                    href="/contact"
