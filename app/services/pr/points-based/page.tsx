...
const content = {
  title: "Points-Based Permanent Residency Programs",
  description:
  ...
  process: [
    "Eligibility assessment (age, education, experience, language)",
    "Profile creation / Expression of Interest (EOI)",
...
export default function PointsBasedPRProgramsPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-6">
            <nav className="flex items-center gap-2 text-[10px] font-black tracking-widest text-zinc-400 uppercase">
              ...
              <ChevronRight size={10} />
              <span className="text-zinc-900">Points-Based</span>
            </nav>
            <motion.h1
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Earn Your Points</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get an expert assessment of your points and profile for top-tier skilled residency programs.
                  </p>
                  <Link
                    href="/contact"
