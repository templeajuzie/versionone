...
const content = {
  ...
  timeline: "2 – 6 months (after eligibility is met)",
  benefits: [
  ...
  countries: [
    ...
    {
      name: "France",
      points: ["10-year long-term residence card", "Renewable and stable", "Access to social benefits"],
    },
    {
      name: "Netherlands",
      points: ["EU long-term resident status after 5 years", "Integration exam required", "Access to EU mobility"],
    },
    {
      name: "Spain",
      points: ["Long-term residence after 5 years", "Renewable permit", "Travel across Schengen area"],
    },
    {
      name: "Italy",
      points: ["Long-term residence permit", "Stable residency rights", "Family reunification options"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-eu-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-eu-pr)" />
  </svg>
);

export default function EULongTermResidencePermitPage() {
  return (
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-[#2D3E75] p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Secure Your Future</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Get help with your EU long-term residence permit application and secure your life in Europe.
                  </p>
                  <Link
                    href="/contact"
