...
import { ArrowRight, CheckCircle2, ChevronRight, Clock, FileText, GraduationCap, ShieldCheck } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

const content = {
  title: "Work to Permanent Residency Pathway",
  description:
  ...
  timeline: "Work Phase: 1 – 5 years | PR Processing: 3 – 12 months",
  benefits: [
  ...
  countries: [
    {
      name: "Canada",
      points: ["Work → Express Entry (CEC)", "Provincial Nominee Programs (PNP)", "Fast PR pathways"],
    },
    {
      name: "Australia",
      points: ["Temporary Skill Shortage → PR (subclass 186)", "Employer-sponsored pathways", "Regional PR options"],
    },
    {
      name: "United Kingdom",
      points: ["Skilled Worker Visa → ILR (after 5 years)", "Continuous employment required"],
    },
    {
      name: "New Zealand",
      points: ["Work to Residence Visa pathways", "Skilled Migrant transition", "Strong family inclusion"],
    },
    {
      name: "Germany",
      points: ["Work Visa / EU Blue Card → PR", "Faster PR for high earners", "Access to EU residency"],
    },
  ],
  who: [
...
const GridPattern = () => (
  ...
  >
    <defs>
      <pattern id="grid-pattern-work-pr" width={200} height={200} x="50%" y={-1} patternUnits="userSpaceOnUse">
        <path d="M.5 200V.5H200" fill="none" />
      </pattern>
    </defs>
    <rect width="100%" height="100%" strokeWidth={0} fill="url(#grid-pattern-work-pr)" />
  </svg>
);

export default function WorktoPermanentResidencyPathwayPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="flex flex-col gap-16 lg:flex-row">
            <div className="flex-1 space-y-20">
              <div>
                <h2 className="text-primary mb-8 flex items-center gap-3 text-2xl font-black">Types of Pathways</h2>
            ...
            <aside className="lg:w-96 lg:shrink-0">
              <div className="sticky top-32 space-y-8">
                ...
                <div className="group relative overflow-hidden rounded-lg bg-zinc-900 p-8 text-white shadow-sm">
                  ...
                  <h3 className="relative z-10 mb-2 text-2xl font-black">Future Secured</h3>
                  <p className="relative z-10 mb-8 text-sm text-zinc-400">
                    Expert assistance for transitioning from work visas to permanent residency.
                  </p>
                  <Link
                    href="/contact"
