    ...
    <div className="">
      ...
      <footer className="bg-black px-4 pt-16 pb-8 text-white md:px-8">
        <div className="mx-auto max-w-7xl">
                      ...
                      <form action="#" method="POST" className="mt-4 space-y-3">
                        <div className="">
                          ...
                          <input
                            ...
                            className="mt-1 w-full rounded-xl bg-white py-2.5 pr-3 pl-3 text-sm ring-1 ring-black/10 outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-neutral-900"
                          />
                        </div>
                        <div className="">
                          ...
                          <div className="relative mt-1">
                            ...
                            <input
                              ...
                              className="w-full rounded-xl bg-white py-2.5 pr-3 pl-9 text-sm ring-1 ring-black/10 outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-neutral-900"
                            />
                          </div>
                        </div>
                        <div className="">
                          ...
                          <textarea
                            ...
                            className="mt-1 w-full resize-y rounded-xl bg-white py-2.5 pr-3 pl-3 text-sm ring-1 ring-black/10 outline-none placeholder:text-neutral-400 focus:ring-2 focus:ring-neutral-900"
                            defaultValue={""}
                          />
                        </div>
                        <button
                          type="submit"
                          className="inline-flex w-full items-center justify-center rounded-xl bg-neutral-900 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-neutral-800"
                        >
                          Send message
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="mt-7">
                      <div className="inline-flex items-center gap-3 rounded-2xl bg-white/95 p-3 shadow-lg ring-1 ring-black/10 backdrop-blur">
                        ...
                        <a
                          ...
                          className="ml-1 inline-flex items-center gap-2 rounded-xl bg-neutral-900 px-3 py-2 text-xs font-medium text-white transition-colors hover:bg-neutral-800"
                        >
                          Ask directly
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Bottom Bar */}
          <div className="mt-20 flex flex-col items-center justify-between gap-8 border-t border-white/10 pt-8 md:flex-row">
