...
const ServicesSnipet = () => {
  return (
    <div>
      <div className="mx-auto grid max-w-7xl grid-cols-1 divide-y divide-gray-200/70 rounded-lg border border-gray-200/70 lg:grid-cols-3 lg:divide-x lg:divide-y-0">
